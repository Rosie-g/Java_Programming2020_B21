...
public class Travel {
    ...
    public static void main(String[] args) {
        ...
        if (validPassport.equalsIgnoreCase("yes")) {
            ...
            System.out.println("Which country do you wanna go");
            ...
            cost = 200;
            System.out.println("When did passport expire");
            ...
            String areTravelling = input.next();

            if(areTravelling.equalsIgnoreCase("yes")){
                cost+=100;
            }else{
                cost+=50;
            }
            System.out.println("Looks like your password has been expired for " + expiredYears +
                    ...
                    + countries + ". Your total cost has come out to" + cost);
        }
