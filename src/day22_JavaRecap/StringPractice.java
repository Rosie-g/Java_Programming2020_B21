...
substring (begin,end): creates substring from beginning till the given ending index(excluded)
substring(begin): creates substring from beginning till end of string
 */