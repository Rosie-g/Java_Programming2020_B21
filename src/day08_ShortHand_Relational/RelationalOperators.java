...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        boolean r2 = num2 > num1; // num 2 is greater than num1

        boolean r3 = num1 < num2; // num 1 is less than num2
        ...
        System.out.println( 10 >= 10 ); // 10 is greater or equal to 10 ==> false
        ...
        boolean is0dd = x % 2 != 0; // opposite of even
