    ...
    public static void main(String[] args) {
      ...
      sentence = sentence.replace("Java","Python"); // "Python is fun, Python is cool"
       ...
       email =  email.replace("gmail", "yahoo");
        ...
        String essay = "Batch 20 is cool, Batch 20 is th best, Batch 20 students are the best";
        ...
        String domain = emailAddress.substring(beginningIndex, endIndex);
        ...
        int n1 = y.indexOf(", J"+2);// second J's index
