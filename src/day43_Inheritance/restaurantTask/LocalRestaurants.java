...
public class LocalRestaurants {
    ...
    public static void main(String[] args) {
        ...
        Server[] servers = {
                new Server("Tom", 29, 'M', 35, "Captain Server", "S001"),
        ...
        restaurant.hireServer(new Server("Yasin", 29, 'M', 35, "Captain Server", "S001"));
        restaurant.hireServer(servers);
        System.out.println(restaurant);

        restaurant.hireChef(new Chef("Mini", 25, 'F', 35, "Executive Chef", "C001"));
        System.out.println(restaurant);
