...
public class EqualityOfNumbers {
    ...
    public static void main(String[] args) {
        ...
        // for all equal  =  n1 == n2 && n1 == n3
        // none of them are equal  =  n1 != n2 && n2 != n3 && n1 != n3

        String result = "";

        if(n1 == n2 && n1 == n3){ // becomes false if non of them are equal
            result = "all equal";
        }else if(n1 == n2){
            result = "n1 & n2 are equal"; // if nit all of them are equal but n1 & n2 are equal
        }else if(n2 == n3){
        ...
        String result2 = (n1 == n2 && n1 == n3)? "all equal" :(n1 == n2)? "n1 & n2 are equal" :(n2 == n3)? "n2 & n3 are equal"
                : (n1 == n3) ? "n1 & n3 are equal" : "none of them are equal";
